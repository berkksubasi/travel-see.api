...
// Read
var getUser = function (userInfo) { return __awaiter(void 0, void 0, void 0, function () {
    var pipeline;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, models_1.UserModel.aggregate(pipeline).exec()];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
// Update
var updateUser = function (userId, updatedUserDTO) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, models_1.UserModel.findByIdAndUpdate(userId, updatedUserDTO, { new: true }).exec()];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
